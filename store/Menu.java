...
public class Menu {
	...
	public void fixedDrinkMenu() {
		...
		this.drinkMenu()[7] = StrawberryYogurt;
		this.drinkMenu()[8] = ChocolateBanana;
		this.drinkMenu()[9] = MangoFruit;
		this.drinkMenu()[10] = PeachYogurt;
		this.drinkMenu()[11] = BlueBerry;
	...
	public void fixedSideMenu() {
		...
		Product SpicyChicken = new Product("스파이시 치킨 샌드위치", 5500, "Sandwich");
